...
# Pull tests
wget "https://drive.google.com/uc?export=download&id=11CLXOIKJzeUHbz7S_xPxgS_7TW4hXhOL" -O hw1.tar.gz || { echo "::error::Unable to download graded tests. Try again."; exit 1; }
